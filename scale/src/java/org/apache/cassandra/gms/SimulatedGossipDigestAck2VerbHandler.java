...
//        }
        ...
        long tmpCurrent = TimePreservingService.getCurrentTimeMillis(WholeClusterSimulator.isReplayEnabled);
        ...
        int sendingBoot = receiverStub.ackNewVersionBoot.get(ackId) != null? receiverStub.ackNewVersionBoot.get(ackId) : 0;
        receiverStub.ackNewVersionBoot.remove(ackId);
        int sendingNormal = receiverStub.ackNewVersionNormal.get(ackId) != null? receiverStub.ackNewVersionNormal.get(ackId) : 0;
